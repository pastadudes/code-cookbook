...
Threading macros (or arrow macros) are used in Clojure for composing many function calls.
...
In this case thanks to the static analyzer we don't need any of the temp variables
